...
#define	MAX_NO_PROCESS						10

#define PROCESS_INITIALIZED					0
...
#define         PRIVILEGED_INSTRUCTION          (short)9
...
#define			ERR_INCORRECT_PRIORITY					-16L
#define			ERR_INCORRECT_PROCESS_NAME				-19L
